    ...
    <header class="main-page-header">
        ...
        <div class="container d-flex">
            ...
            <nav class="main-nav mr-2 d-flex align-items-center">
                <li> <i class="fa fa-desktop"></i> <a href="/user/dashboard" class=" text-light">Dashboard</a></li>
                <li> <i class="fa fa-user"></i>Projects</li>
            ...
            <!-- Login Identifier -->
            <div class="login-identifier alert alert-warning py-1 px-1">
